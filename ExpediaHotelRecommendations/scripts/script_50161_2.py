...
def prepare_arrays_match():
    ...
    while 1:
        ...
        if srch_destination_id != '' and hotel_country != '' and hotel_market != '' and is_package != '' and book_season != -1:
            s2 = (srch_destination_id,hotel_country,hotel_market,is_package, book_season)
